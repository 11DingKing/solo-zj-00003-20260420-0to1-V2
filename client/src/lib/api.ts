...
export const technicianApi = {
  getAll: () =>
    api.get<{ success: boolean; data: Technician[] }>("/technicians"),
  getById: (id: number) =>
    api.get<{ success: boolean; data: Technician }>(`/technicians/${id}`),
  create: (data: Omit<Technician, "id">) =>
    api.post<{ success: boolean; data: Technician }>("/technicians", data),
...
export const scheduleApi = {
  ...
  getByTechnicianAndDate: (technicianId: number, date: string) =>
    api.get<{ success: boolean; data: Schedule[] }>(
      `/schedules/technician/${technicianId}/${date}`,
    ),
};
...
export const notificationApi = {
  ...
  getUnreadCount: (params: { receiver_id: string; receiver_type: string }) =>
    api.get<{ success: boolean; data: number }>("/notifications/unread-count", {
      params,
    }),
  markAsRead: (id: number) =>
    api.put<{ success: boolean; data: Notification }>(
      `/notifications/${id}/read`,
    ),
  markAllAsRead: (params: { receiver_id: string; receiver_type: string }) =>
